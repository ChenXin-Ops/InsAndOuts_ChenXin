...
frameRate(30);
fill(255,0,0);
text("When your ready, press 1, 2, 3, 4, 5, 6, 7, 8, or 9 to begin",50,50);
text("press 0 to go to menu page at any time!",50,100);
...
text("A) NO",300,200);
text("B) YES",300,240);
text("C) I DONT KNOW!",300,280);
text("D) What a stupid question!",300, 320);
text("Is there Pizza in SPACE!?",300,30);
if (key=='a' || key=='A'){
  s1();
  textSize(50);
    fill(76,200,250);
...
randomdots();
 ...
 textSize(32);
 fill(0, 0, 153);
text("A) BMW M1 Procar",300,200);
text("B) BMW M3 e30 DTM",300,240);
text("C) BMW M5 E60",300,280);
text("D) Seriously, what the hell are you talking ABOUT!!??",300,320);   
text("What car is this?",300,30);
   if (key=='a' || key=='A'){
  s4();
  fill(0, 0, 153);
  textSize(50);
...
text("B) PGR3",300,240);
text("C) PGR4",300,280);
text("D) Plant Growth Regulator 1-4",300,320); 
text("What game is this?",300,30);
  if (key=='a' || key=='A'){
  s5();
  fill(204, 51, 0);
  textSize(50);
...
if(Q==4){
 ...
 textSize(32);
 fill(128, 0, 0);
text("A) Starting 3 number*1000" ,300,200);
text("B) Starting 3 number(7*13*9*11)",300,240);
text("C) Starting 3 number(7*11*13) or 117*1001",300,280);
text("D) You can't never get those numbers by multiplying!",300,320); 
text("What do you multiply to get the number (100,100), (102,102)...(999,999)?",100,30);
  if (key=='a' || key=='A'){
  s6();
  fill(128, 0, 0);
  textSize(50);
...
image(lol,0,0);
fill(0);
text("YEAH, PROVE ME WRONG THEN!!",300,300);
fill(255);
textSize(20);
text(word[phrasesr] ,0,50);
}
...
if(Q==5){
 ...
 textSize(32);
 fill(102, 0, 102);
text("A) Intercommunication Device Equipment!" ,300,200);
text("B) Inner Dog Expained!",300,240);
text("C) Inner Door Express",300,280);
text("D) Go F*** Yourself!, Please!",300,320); 
text("What is my definition of IDE stands for?",300,30);
  if (key=='a' || key=='A'){
  s7();
  fill(102, 0, 102);
  textSize(50);
...
if(Q==6){
 ...
 textSize(32);
 fill(128, 0, 0);
text("A) BEAT THE HELL OUT OF HIM/HER!" ,300,200);
text("B) CURSE AT HIM/HER!",300,240);
text("C) KILLED HIM/HER",300,280);
text("D) SHOW HIM/HER WHO'S THE BOSS!",300,320); 
text("What do you choose if you're mad at someone?",300,30);
  if (key=='a' || key=='A'){
   s8();
  fill(128, 0, 0);
  textSize(50);
...
fill(128, 0, 0);}
  ...
  fill(128, 0, 0);
  textSize(50);
text("YOU'RE GOING TO JAIL, MY FRIEND!!",400,300);
frameRate(10);
fill(255);}
...
if(Q==7){
 ...
 textSize(32);
 fill(255, 255, 153);
text("A) X Bomber On X-clound" ,300,200);
text("B) X Boxerster Over X",300,240);
text("C) X Bunny Older X",300,280);
text("D) STUPID BI***, IT'S MICROSOFT XBOX!",300,320); 
text("What does XBOX stand for?",300,30);
  if (key=='a' || key=='A'){
   s9();
  fill(255, 255, 153);
  textSize(50);
...
if(Q==8){
 ...
 textSize(32);
 fill(0, 51, 102);
text("A) HOW I'M SUPPOSE TO KNOW!" ,300,200);
text("B) WHAT EXACTLY ARE YOU ASKING ME AGAIN??",300,240);
text("C) WHAT THE F***!! ",300,280);
text("D) WOW, ... NO CLUE!",300,320); 
text("What City Is This In The Background?",300,30);
  if (key=='a' || key=='A'){
   s10();
  fill(0, 51, 102);
  textSize(50);
  text("TAKE A GOD DAMN GUESS! ",500,280);
  fill(255);}
 else if(key=='b' || key=='B'){
 s10();
fill(255, 0, 0);
...
fill(0, 51, 102);}
  ...
  fill(0, 51, 102);
  textSize(40);
text("YOU'RE A LITTLE QUICK-TEMPERED,HUH! WHAT A SOB YOU ARE!!",100,300);
frameRate(10);
fill(255);}
...
if(Q==9){
 ...
 textSize(32);
 fill(255, 153, 0);
text("A) I HAVE ENOUGH THINGS TO WORRY ABOUT!" ,300,200);
text("B) IT'S COOL!",300,240);
text("C) YOU COULDN'T ASK A BETTER QUESTION!!??",300,280);
text("D) I DON'T NEED TO TELL YOU!",300,320); 
text("WHAT DO YOU THINK OF SPACE?",300,30);
  if (key=='a' || key=='A'){
   s11();
  fill(255, 153, 0);
  textSize(50);
  text("FAIR ENOUGH!",100,280);
  fill(255);}
 else if(key=='b' || key=='B'){
 s11();
textSize(50);
text("HOW COOL IS IT!!??",500,280);
fill(255, 153, 0);}
else if (key=='c'|| key=='C'){
   s11();
  fill(255, 153, 0);
  textSize(50);
text("I THINK IT IS A GREAT QUESTION!!, OK?",400,300);
frameRate(10);
fill(255);}
...
image(lol,0,0);
fill(0);
text("YOU DON'T HAVE TO TELL ME ANYTHING BECAUSE YOU'RE ALREADY FAILED!!",100,500);
fill(255);
textSize(20);
text(word[phrasesr] ,0,50);
}
